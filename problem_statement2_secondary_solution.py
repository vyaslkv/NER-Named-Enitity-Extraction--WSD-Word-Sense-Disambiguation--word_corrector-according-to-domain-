...
if __name__ == '__main__':
	...
	moneyfile = codecs.open("depositmoney.txt", 'r', 'utf-8')
	sent1 = moneyfile.read().lower()
	accountfile = codecs.open("depositaccount.txt", 'r', 'utf-8')
	sent2 = accountfile.read().lower()
	sent3 = "start"
	while(sent3 != "end"):
